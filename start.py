    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:
            ...
            if time > 181:
                ...
                response = f"☣️BGMI D-DoS Attack is on Progress with High Power.\n\nTarget: {target} Port: {port} Time: {time} Seconds\n\n👛Dm to Buy : @bhoothihu / @devz_on"
        else:
